...
usuario(2,'Patri Rodriguez','Funes').
...
intereses(3,['futbol','astrologia','cine','Retrofest']).
intereses(4,['TC 2000', 'Saga Star Wars', 'perros', 'U2', 'tenis']).
intereses(5,['comida mexicana', 'ingenieria en sistemas', 'formula 1','futbol']).
intereses(6,['pelicula El ciudadano ilustre','tenis','meditaciin','Psicologia']).
...
intereses(9,['cumbia','diario clarin','redes neuronales','TC 2000']).
